  ...
  return (
    <nav className="border-b bg-white z-20 fixed left-0 right-0 top-0 border-gray-200 px-4 py-3 flex justify-between items-center shadow-sm">
      ...
      <div className=" flex gap-2 lg:gap-5 items-center">
        ...
        <Button
          className="relative hover:bg-gray-300 rounded-full cursor-pointer border-none shadow-none group w-full h-full"
          variant="outline"
          onClick={() => router.push(`/profile/${user.username}`)}
        >
          <Image src={user.avatar} alt="Profile" width={35} height={35} />
