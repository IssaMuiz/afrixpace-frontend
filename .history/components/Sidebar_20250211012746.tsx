...
const Sidebar = ({ isOpen, setIsSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebarRef}
      className={cn(
        "fixed top-[61px] w-full left-0 bottom-0 border-r bg-gray-50 border-gray-200 h-screen dark:bg-gray-900 px-4 pt-12 transition-transform xl:z-0 z-50  xl:translate-x-0",
