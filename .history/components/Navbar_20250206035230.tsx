    ...
    <nav className="border-b bg-white z-20 fixed left-0 right-0 top-0 border-gray-200 px-4 py-3 flex justify-between items-center">
      ...
      <div className=" flex space-x-2">
        <div className=" relative ">
          ...
          <span className="absolute left-1/2 -translate-x-1/2 mt-12 px-2 py-1 text-sm text-white bg-gray-800 rounded opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
            Notification
          </span>
        </div>
        <Button
