  ...
  return (
    <nav className="border-b bg-white z-20 fixed left-0 right-0 top-0 border-gray-200 px-4 py-3 flex justify-between items-center">
      ...
      <div className=" flex space-x-2">
        <Button
          className="absolute hover:bg-gray-300 rounded-full cursor-pointer border-none shadow-none p-1 "
          variant="outline"
        >
          <BellIcon className="min-h-7 min-w-7" />
          <span className="relative text-white rounded-full p-1 bg-red-600">3</span>
        </Button>
        <Button
