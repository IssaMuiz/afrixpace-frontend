...
const Navbar = () => {
  return (
    <nav className="border-b border-gray-200 px-6 py-3 flex justify-between items-center shadow-sm">
      ...
      <div className=" flex gap-4">
        <Button className="hover:bg-white hover:text-black ">Login</Button>
